...
class TestClickConstructorFirefox:
    def test_success_click_constructor_firefox(self, login_in_account_firefox):
        # act
        login_in_account_firefox.find_element(*Locators.BUT_PERSONAL_ACCOUNT).click()
        WebDriverWait(login_in_account_firefox, 3).until(expected_conditions.invisibility_of_element_located(Locators.INVISIBLE_ELEMENT))
        login_in_account_firefox.find_element(*Locators.BUT_CONSTRUCTOR).click()
        WebDriverWait(login_in_account_firefox, 3).until(expected_conditions.invisibility_of_element_located(Locators.INVISIBLE_ELEMENT))
        # assert
